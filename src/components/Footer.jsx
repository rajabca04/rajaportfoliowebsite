function Footer() {
  return (
    <>
      ...
      <div className="sm:flex ms-5 mb-5 sm:items-center sm:justify-between">
        <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">
          © 2024{" "}
          <a href="#1" className="hover:underline">
            Raja-Kumar-portfolio™
          </a>
          . All Rights Reserved.
        </span>
        <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0 mr-5">
        <a
            href="https://www.linkedin.com/in/raja-kumar-545526186/"
          ...
          <a
            href="https://www.facebook.com/rajakumar.sharma.3762"
            className="text-gray-500 hover:text-gray-900 dark:hover:text-white"
          >
            <svg
              className="w-5 h-5"
          ...
          <a
            href="https://www.instagram.com/ethical_raja_official/"
            className="text-gray-500 hover:text-gray-900 dark:hover:text-white"
          >
            <svg
              className="w-5 h-5"
          ...
          <a
            href="https://twitter.com/rajabca201804"
            className="text-gray-500 hover:text-gray-900 dark:hover:text-white"
          >
            <svg
              className="w-5 h-5"
          ...
          <a
            href="https://github.com/rajabca04"
            className="text-gray-500 hover:text-gray-900 dark:hover:text-white"
          >
            <svg
              className="w-5 h-5"
